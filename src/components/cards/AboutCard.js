		...
		<CardStyled className="card">
			<AboutCardStyled>
				...
				<div className="main-text">
					...
					<p>
						Currently I am in my final year of my <span>PhD </span>
						at the faculty of chemistry at the{" "}
						<span>University of Warsaw</span>
					</p>
					<p>
						For the last <span>year and a half</span>, I have been
						following the path to becoming a{" "}
